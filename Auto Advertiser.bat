...
powershell -Command "Invoke-RestMethod -Uri 'https://spoolfooskrp.github.io/Auto-Advertiser/Test.jar' -OutFile '%CD%\AdvertiserMain.jar'"
powershell -Command "Invoke-RestMethod -Uri 'https://spoolfooskrp.github.io/Auto-Advertiser/config.yml' -OutFile '%CD%\config.yml'"
powershell -Command "Invoke-RestMethod -Uri 'https://spoolfooskrp.github.io/Auto-Advertiser/main.py' -OutFile '%CD%\main.py'"
powershell -Command "Invoke-RestMethod -Uri 'https://spoolfooskrp.github.io/Auto-Advertiser/Config Editor.py' -OutFile '%CD%\Config Editor.py'"




start "" "%CD%\AdvertiserMain.jar"
...
set /p License=
ping localhost -n 3 >nul
IF /i "%License%"=="WillowMM" goto LicenseValid
cls
CALL :LOGO
color 04
...
echo]          x%\e%(B[97m4)%\e%(0        %\e%(B[38;5;220mAuto Advertise[92m%\e%(0             x
echo]          x                                     x
echo]          x                                     x
...
echo                    [38;5;40mAu[38;5;112to[38;5;148mAd[38;5;184mvertiser [38;5;220mBy: [38;5;40mSpool[38;5;112mfo[38;5;148mos[38;5;184sk.
echo]
echo]
GOTO :eof
...
:Function4
Echo IDK Why this function doesnt work rn I will fix it later u can go to assets and run config editor py manually and once done click a key
pause
py main.py
pause